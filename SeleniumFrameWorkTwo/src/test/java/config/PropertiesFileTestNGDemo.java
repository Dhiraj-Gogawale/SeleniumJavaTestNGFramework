...
import ScriptTests.TestNGDemoForPropertiesFileOperations;

public class PropertiesFileTestNGDemo {
	...
	public static void getProperties() {
		try {
			...
			TestNGDemoForPropertiesFileOperations.browserName=browser;
